...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "WM Legal Services — Specialist Property Law" },
      { name: "description", content: "Specialist property law team operating under Taylor Rose. Conveyancing, auction conveyancing, panel management and partner services." },
      { property: "og:title", content: "WM Legal Services — Specialist Property Law" },
